        ...
        <div className="container border-top mt-5" >
            <div className='row'>
                <div className='col'>
                    ...
                    <p className='fs-25 text-muted mt-3'>© 2010 - 2025, Zerodha Broking Ltd.
